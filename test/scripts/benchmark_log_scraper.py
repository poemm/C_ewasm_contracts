...
def get_runtimes_from_stderr_textfile(infile,engine,testcase,outfile):
  ...
  for line in fin:
    ...
    #looking for lines of form:   Time [us]: 54838 (instantiation: 31745, execution: 23092)
    if line[0:10] == "Time [us]:":
      words = line.split() #split on whitespace
      instantiation_times.append(int(words[4][:-1]))
      invocation_times.append(int(words[6][:-1]))
