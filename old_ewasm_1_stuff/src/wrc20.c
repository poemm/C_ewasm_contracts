...
/*
Implements spec: https://gist.github.com/axic/16158c5c88fbc7b1d09dfa8c658bc363

Passes the four spec tests.
*/
...
void do_transfer() {
  ...
  *(i64*)value = reverse_bytes_64(*(i64*)value);

  // get balances
  storageLoad((i32ptr*)sender, (i32ptr*)sender_balance);
  storageLoad((i32ptr*)recipient, (i32ptr*)recipient_balance);
  *(i64*)sender_balance = reverse_bytes_64(*(i64*)sender_balance);
  *(i64*)recipient_balance = reverse_bytes_64(*(i64*)recipient_balance);
