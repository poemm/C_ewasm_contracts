...
/*
One change we make is edit the FIPS202_SHA3_256 to have padding constant 0x01 instead of 0x06
*/
...
void FIPS202_KECCAK_256(const unsigned char *input, unsigned int inputByteLen, unsigned char *output)
{
...
void _main(){
  ...
  FIPS202_KECCAK_256(in,length,out);
